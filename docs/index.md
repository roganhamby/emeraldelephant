...
Finally, let's look at bills.  Groceries are their own bills but everything else is tracked in money.billing.  The money.billing table has one very important column: xact.  This links to money.billable_xact's id column.  This means that everytime you have a bill on a circulation it becomes an entry in money.billing.  To illustrate the point let us imagine a book that has been checked out and generated some bills:
